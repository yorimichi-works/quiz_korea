...
export default function PrivacyPage() {
  return <LegalPage title="개인정보 처리방침" description="먼저!는 실시간 퀴즈 대전을 제공하는 데 필요한 최소한의 정보만 처리합니다.">
    <LegalSection title="1. 처리하는 정보">
      ...
      <p>Google 이메일과 표시 이름은 계정 화면에 표시될 수 있으나, 먼저!의 게임 데이터베이스에는 별도로 저장하지 않습니다.</p>
    </LegalSection>
    ...
    <LegalSection title="4. 외부 서비스">
      <p>인증에는 Google Firebase Authentication을 사용하며, 서비스 제공을 위해 클라우드 호스팅 및 데이터베이스 인프라를 이용합니다. 각 사업자는 서비스 제공에 필요한 범위에서 정보를 처리합니다.</p>
    </LegalSection>
